...
# Install Kustomize
curl -L https://github.com/kubernetes-sigs/kustomize/releases/download/kustomize%2Fv$(echo ${KUSTOMIZE_VERSION}|tr -d kustomize/)/kustomize_v$(echo ${KUSTOMIZE_VERSION}|tr -d kustomize/)_linux_${ARCH}.tar.gz | tar -xzC ${DEST}
